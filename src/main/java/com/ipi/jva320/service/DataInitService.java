...
public class DataInitService implements CommandLineRunner {
    ...
    public void run(String... argv) throws Exception {
        ...
        SalarieAideADomicile s1 = this.salarieAideADomicileService.creerSalarieAideADomicile(
                new SalarieAideADomicile("Ibrahima", LocalDate.parse("2022-12-05"), LocalDate.parse("2022-12-05"),
                        20, 0,
                        80, 10, 1));

        this.salarieAideADomicileService.creerSalarieAideADomicile(
                new SalarieAideADomicile("khalile", LocalDate.parse("2022-12-05"), LocalDate.parse("2022-12-05"),
                        20, 0,
                        80, 10, 1));
